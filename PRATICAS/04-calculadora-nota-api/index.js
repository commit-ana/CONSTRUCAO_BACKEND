...
//configuro a minha aplicação pra usar o router (CaluladoraNota) como intermedário
app.use('/', calculadoraNotaRouter)
// Executo a aplicação (Minha API)
app.listen(3000, () => {
    console.log("Sua aplicação (API) está rodando em http://localhost:3000")
})